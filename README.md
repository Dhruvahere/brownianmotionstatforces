...
Diffusion Generative Models learn a socre function that is a log density function. This log density function is also the same as the negative gradient of a potential, which constitutes the forces that make up a simulation of some molecule. 
